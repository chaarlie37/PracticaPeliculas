 ...
 * @author Mario
 */
public class VentanaCompartir extends javax.swing.JFrame {
    ...
    public JComboBox<String> getjComboAQuien() {
        return jComboAQuien;
    }
    ...
    /**
     * Creates new form VentanaCompartir
     */
    public VentanaCompartir() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaCompartir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCompartir().setVisible(true);
            }
        });
    }
