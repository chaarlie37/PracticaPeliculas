 ...
 * @author Mario
 */
public class VentanaAmigo extends javax.swing.JFrame {

    /**
     * Creates new form VentanaAmigo
     */
    public VentanaAmigo() {
        initComponents();
    }

    public JLabel getjLabelNombreAmigo() {
        return jLabelNombreAmigo;
    }

    public JLabel getjLabelMuroAmigo() {
        return jLabelMuroAmigo;
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelMuroAmigo, javax.swing.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAmigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAmigo().setVisible(true);
            }
        });
    }
